...
import io.openems.edge.batteryinverter.refu100k.enums.*;
import io.openems.common.channel.Level;
import io.openems.common.channel.Unit;
import io.openems.common.types.OpenemsType;

public interface RefuStore100k extends OpenemsComponent, EventHandler {
...
//		SYSTEM_WORKMODE(Doc.of(SystemWorkmode.values())), //
		...
		STATUS_INVERTER_2(Doc.of(Level.INFO).text("Enabled")),
		STATUS_INVERTER_3(Doc.of(Level.INFO).text("Fault")),
		...
		STATUS_DCDC_1(Doc.of(Level.INFO).text("Ready for Operating")),
		STATUS_DCDC_2(Doc.of(Level.INFO).text("Enabled")),
		STATUS_DCDC_3(Doc.of(Level.INFO).text("DCDC Fault")),
		STATUS_DCDC_4(Doc.of(Level.INFO).text("DcDC Warning")),
